...
CREATE TABLE `m_doctor` (
  ...
  `doctor_permenant_address` varchar(200) DEFAULT NULL,
  `doctor_contact` varchar(45) DEFAULT NULL,
  `doctor_gender` varchar(45) DEFAULT NULL,
  `doctor_adhar_details` varchar(45) DEFAULT NULL,
  `doctor_pan_details` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2019-06-29 19:25:46

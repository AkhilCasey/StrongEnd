...
CREATE TABLE `m_department` (
  ...
  `department_floor` varchar(45) DEFAULT NULL,
  `department_phone` varchar(45) DEFAULT NULL,
  `department_location` varchar(45) DEFAULT NULL,
  `department_doctor_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`department_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='master department data';
...
-- Dump completed on 2019-06-05 12:55:43

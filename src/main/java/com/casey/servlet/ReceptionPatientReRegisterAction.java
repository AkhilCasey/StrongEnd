 ...
 * @author cynber
 */
@WebServlet(name = "ReceptionPatientReRegisterAction", urlPatterns = {"/ReceptionPatientReRegisterAction"})
public class ReceptionPatientReRegisterAction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ReceptionPatientReRegisterAction</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ReceptionPatientReRegisterAction at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
 ...
 try {
            ...
            rp.setOldid(Integer.parseInt(request.getParameter("patientid")));
            ReceptionPatientRegisterManager rpm = new ReceptionPatientRegisterManager();
            int id = rpm.insertRePatient(rp);

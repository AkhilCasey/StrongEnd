 ...
 * @author cynber
 */
@WebServlet(name = "PharmacyMedicineInsertAction", urlPatterns = {"/PharmacyMedicineInsertAction"})
public class PharmacyMedicineInsertAction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PharmacyMedicineInsertAction</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PharmacyMedicineInsertAction at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
